...
export class AuthService extends BaseService {
   ...
   */
  authControllerAuth$Response(params?: {
  },
  context?: HttpContext

): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, AuthService.AuthControllerAuthPath, 'get');
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  authControllerCallback$Response(params: {
    code: string;
  },
  context?: HttpContext
   ...
   * This method doesn't expect any request body.
   */
  authControllerWhoami$Response(params?: {
  },
  context?: HttpContext
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, AuthService.AuthControllerLogoutPath, 'get');
    if (params) {
    }
